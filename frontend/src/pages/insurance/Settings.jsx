...
const secondaryMetrics = [
  ...
  { label: 'Last Deployment', value: 'Dec 14, 2025', detail: 'v2.8.3, rolling update', trend: 'Successful', trendColor: 'text-emerald-400', icon: GitBranch },
  { label: 'System Uptime', value: '47 days, 14h', detail: 'Since Oct 28, 2025', trend: 'No interruptions', trendColor: 'text-emerald-400', icon: Clock },
...
const systemLogs = [
  { id: 1, timestamp: '2025-12-16 14:32:18', level: 'INFO', service: 'API Server', message: 'Request completed: GET /api/claims - 200 OK (145ms)', source: 'api-gateway' },
  { id: 2, timestamp: '2025-12-16 14:32:15', level: 'WARN', service: 'Disk Storage', message: 'Disk usage exceeded 80% threshold on /data partition', source: 'monitor' },
  { id: 3, timestamp: '2025-12-16 14:31:58', level: 'INFO', service: 'ML Pipeline', message: 'Fraud prediction batch completed: 2,340 claims processed in 4.2s', source: 'ml-engine' },
  { id: 4, timestamp: '2025-12-16 14:31:42', level: 'ERROR', service: 'Notification', message: 'Failed to send email notification to admin@healthsec.com - SMTP timeout', source: 'notification-svc' },
  { id: 5, timestamp: '2025-12-16 14:31:30', level: 'INFO', service: 'Database', message: 'Connection pool stats: active=47, idle=153, waiting=0', source: 'db-pool' },
  { id: 6, timestamp: '2025-12-16 14:31:15', level: 'INFO', service: 'Auth', message: 'User login: admin_insurance from 192.168.1.45', source: 'auth-service' },
  { id: 7, timestamp: '2025-12-16 14:30:58', level: 'WARN', service: 'GPU', message: 'GPU temperature reached 72\u00B0C - approaching thermal threshold', source: 'gpu-monitor' },
  { id: 8, timestamp: '2025-12-16 14:30:45', level: 'INFO', service: 'ML Pipeline', message: 'Model v3.2.1 prediction accuracy: 94.6% on validation set', source: 'ml-engine' },
  { id: 9, timestamp: '2025-12-16 14:30:20', level: 'INFO', service: 'Queue', message: 'Message queue consumer started: claim-processor (batch size: 50)', source: 'queue-mgr' },
  { id: 10, timestamp: '2025-12-16 14:29:55', level: 'INFO', service: 'API Server', message: 'POST /api/notifications/generate - 201 Created (312ms)', source: 'api-gateway' },
  { id: 11, timestamp: '2025-12-16 14:29:30', level: 'DEBUG', service: 'Cache', message: 'Redis cache hit ratio: 94.2% (hits: 12,450, misses: 756)', source: 'cache-mgr' },
  { id: 12, timestamp: '2025-12-16 14:29:15', level: 'INFO', service: 'Scheduler', message: 'Daily backup job scheduled for 02:00 AM EST', source: 'scheduler' },
  { id: 13, timestamp: '2025-12-16 14:28:45', level: 'ERROR', service: 'Claim Parser', message: 'Failed to parse claim CLM-2025-091234: invalid ICD-10 format', source: 'parser' },
  { id: 14, timestamp: '2025-12-16 14:28:30', level: 'INFO', service: 'Database', message: 'Automated index optimization completed: 3 indexes rebuilt', source: 'db-maint' },
  { id: 15, timestamp: '2025-12-16 14:28:10', level: 'INFO', service: 'API Server', message: 'GET /api/stats - 200 OK (89ms)', source: 'api-gateway' },
  { id: 16, timestamp: '2025-12-16 14:27:55', level: 'WARN', service: 'Memory', message: 'Memory usage at 78% - monitoring for potential leak', source: 'system-monitor' },
  { id: 17, timestamp: '2025-12-16 14:27:30', level: 'INFO', service: 'ML Pipeline', message: 'Feature extraction completed for 1,890 new claims', source: 'ml-engine' },
  { id: 18, timestamp: '2025-12-16 14:27:10', level: 'INFO', service: 'Auth', message: 'Session token refreshed for user: auditor_insurance', source: 'auth-service' },
  { id: 19, timestamp: '2025-12-16 14:26:50', level: 'DEBUG', service: 'Queue', message: 'Dead letter queue: 0 messages (all processed)', source: 'queue-mgr' },
  { id: 20, timestamp: '2025-12-16 14:26:30', level: 'INFO', service: 'Export', message: 'CSV export completed: 12,450 records (2.3 MB)', source: 'export-svc' },
];
