  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-bg">
      <div className="w-full max-w-sm">
        <div className="mb-8">
          <div className="text-textPrimary text-base font-medium mb-1">Fraud Detection System</div>
          <div className="text-textSecondary text-sm">Sign in to your account</div>
        </div>
        ...
        <div className="mt-6 pt-5 border-t border-border">
          <div className="text-xs text-textSecondary mb-3">Demo accounts</div>
          <div className="space-y-2">
            {[
              { label: 'Insurance Company', user: 'insurance', pass: 'insurance' },
              { label: 'Provider (City General)', user: 'provider1', pass: 'provider1' },
              { label: 'Provider (Metro Health)', user: 'provider2', pass: 'provider2' },
            ].map((d) => (
              <button
                key={d.user}
                type="button"
